...
<body>
	<div class="all-all">
		...
		<div class="w3-content"
			...
			myCarousel.absolute {
				...
				<div class="carousel-inner">
					...
					<div class="item active">
						<img src="/project/img/1.jpg" style="width: 100%"
							alt="First slide">
						<div class="container">
               ...
               <p>텍스트 1</p> -->
					...
					<!--슬라이드2-->
					<div class="item">
						<img src="/project/img/2.jpg" style="width: 100%" data-src=""
							alt="Second slide">
						<div class="container">
							<div class="carousel-caption">
								<!-- <h1>Slide 2</h1>
               <p>텍스트 2</p> -->
					...
					<!--슬라이드3-->
					<div class="item">
						<img src="/project/img/3.jpg" style="width: 100%" data-src=""
							alt="Third slide">
						<div class="container">
							<div class="carousel-caption">
								<!-- <h1>Slide 3</h1>
               <p>텍스트 3</p> -->
					...
					<!--슬라이드4-->
					<div class="item">
						<img src="/project/img/4.jpg" style="width: 100%" data-src=""
							alt="Fourth slide">
						<div class="container">
							<div class="carousel-caption">
								<!-- <h1>Slide 4</h1>
               <p>텍스트 4</p> -->
					...
					<!--슬라이드5-->
					<div class="item">
						<img src="/project/img/5.jpg" style="width: 100%" data-src=""
							alt="Fifth slide">
						<div class="container">
							<div class="carousel-caption">
								<!-- <h1>Slide 5</h1>
               <p>텍스트 5</p> -->
					...
					<!--슬라이드6-->
					<div class="item">
						<img src="/project/img/6.jpg" style="width: 100%" data-src=""
							alt="Sixth slide">
						<div class="container">
							<div class="carousel-caption">
								<!-- <h1>Slide 6</h1>
			...
			<div class="right" id="right">ghasdfasdfasdf</div>
		</div>
	</div>
</body>
</html>