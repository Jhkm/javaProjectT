...
<body>
		...
		<table>
			...
			<tr>
				...
				<td width="70%"><input type="text"
					style="text-align: center; border: 0px none; background: transparent;"
					id="oldAddress" name="oldAddress" value="${loginUser1.m_address }"
					size="100"> <br>
				<input type="button" id="addressUpdate" value="배송지 수정"> <br>
				<input type="text" class="newAddress" id="newAddress"
					name="newAddress" size="100"> <br>
				<input type="button" class="newAddress" id="updateSet"
					value="배송지 수정 완료"></td>
			</tr>
			<tr>
	...
	<table>
		...
		<tr>
			...
			<td>${itemSet.quantity * itemSet.item.i_price }원</td>
		</tr>
		<tr>
			<td colspan="4"><a href="javascript:finalize()">구매</a>&nbsp; <a
				href="../item/list.sdj">상품목록</a></td>
		</tr>
	</table>
	<h2>최종 결제 금액</h2>
	<input type="text" style="text-align: right;" id="final_money"
		value="${itemSet.quantity * itemSet.item.i_price }" readonly>
	원
</body>
</html>