...
<body>
	...
	<div align="center">
		<table width="80%">
			<tr>
				<td align="center" width="140"><img alt="상품 이미지" src="../picture/${item.i_img }" width="120" height="100"></td>
			</tr>
			<tr><td align="center">${item.i_name }</td></tr>
		</table>
	...
	<input type="hidden" name="m_id" value="${sessionScope.loginUser }">
		...
		<textarea rows="8" cols="55" name="b_content"></textarea><br>
