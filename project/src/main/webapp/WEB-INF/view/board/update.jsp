		...
		<form:form modelAttribute="board" action="update.sdj" method="post"
			...
			<c:if test="${param.b_category == '5'}">
				...
				<div class="w3-cell-row">
					...
					<div class="w3-container w3-sand w3-cell w3-cell-bottom"
						align="left" style="max-width: 60%;">
						<form:input path="b_state" id="asdf" name="sAddress"
							class="postcodify_address" value="" />
						<font color="red"><form:errors path="b_state" /></font><br> <input
							type="text" name="b_state" id="b_state"
							class="postcodify_details" value="" onfocus="drawmap()" />
					</div>
					<div class="w3-container w3-sand w3-cell" align="left"
						style="max-width: 20%;">
						<input type="button" id="postcodify_search_button"
							class="w3-button w3-sand w3-right" value="주소찾기">
					</div>
				</div>
				<div class="w3-cell-row">
					<div class="w3-container w3-teal w3-cell" style="width: 20%;">
			...
			<div class="w3-cell-row w3-right" style="margin-top:1%;">
					<a href="javascript:document.f.submit()"><button class="w3-btn w3-white w3-border w3-border-blue w3-round-large">게시물 수정 </button></a>
		
				 <a	href="javascript:history.go(-1)"><button class="w3-btn w3-white w3-border w3-border-blue w3-round-large">뒤로가기</button></a>
			</div>
